...
import com.wipro.digital.config.Constants;
import com.wipro.digital.gateway.JWTTokenRelayFilter;
import com.wipro.digital.security.AuthoritiesConstants;
import com.wipro.digital.security.Http401UnauthorizedEntryPoint;
import com.wipro.digital.security.jwt.JWTConfigurer;
import com.wipro.digital.security.jwt.TokenProvider;
...
public class JwtSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private final AcceleratorProperties acceleratorProperties;
    ...
    public JwtSecurityConfiguration(@Value("${spring.security.user.name}") String username,
                                    ...
                                    AcceleratorProperties acceleratorProperties) {
        this.username = username;
        this.password = password;
        this.roles = roles;
        this.authenticationManagerBuilder = authenticationManagerBuilder;
        this.authenticationEntryPoint = authenticationEntryPoint;
        this.acceleratorProperties = acceleratorProperties;
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
         ...
         .and()
            .httpBasic()
            .realmName("Accelerator Framework")
        .and()
            .authorizeRequests()
    ...
    public TokenProvider tokenProvider() {
        return new TokenProvider(acceleratorProperties);
    }
